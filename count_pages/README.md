...
In addition you can calculate word counts, and a variety of readability statistics such as [Flesch-Kincaid](http://en.wikipedia.org/wiki/Flesch%E2%80%93Kincaid_readability_test) and [Gunning Fog](http://en.wikipedia.org/wiki/Gunning_fog_index) index.

For more information, see the [Wiki](https://github.com/kiwidude68/calibre_plugins/wiki/Count-Pages)
