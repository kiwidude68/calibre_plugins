...
This plugin allows Calibre to read book information from [goodreads.com](https://www.goodreads.com/) when you choose to download/fetch metadata. 

Adding this plugin can potentially increase both the success rate and quality of information retrieved for some of your books.

For more information, see the [Wiki](https://github.com/kiwidude68/calibre_plugins/wiki/Goodreads)
