...
DEFAULT_MENU_SET = [
        (False, 'Audible for Author',             '', False, 'stip_audible.png',   'https://www.audible.com/search?keywords={author}','utf-8', 'GET'),
        (False, 'Audible for Book',               '', False, 'stip_audible.png',   'https://www.audible.com/search?keywords={author}+{title}','utf-8', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        ...
        (False, 'Barnes and Noble for ISBN',      '', False, 'stip_bn.png',        'https://www.barnesandnoble.com/s/{isbn}/_/M-8q8', 'utf-8', 'GET'),
        (False, 'Barnes and Noble for Title',     '', False, 'stip_bn.png',        'https://www.barnesandnoble.com/s/{title}/_/M-8q8', 'utf-8', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        ...
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'EBooks for Author',              '', False, 'stip_ebooks.png',    'https://www.ebooks.com/SearchApp/SearchResults.net?term={author}&RestrictBy=author', 'utf-8', 'GET'),
        (False, 'EBooks for Book',                '', False, 'stip_ebooks.png',    'https://www.ebooks.com/SearchApp/SearchResults.net?term={author}+{title}', 'utf-8', 'GET'),
        (True,  '', '', False, '', '', '', 'GET'),
        (True,  'FantasticFiction for Author',    '', False, 'stip_ff.png',        'https://www.fantasticfiction.com/search/?searchfor=author&keywords={author}', 'utf-8', 'GET'),
        (True,  'FantasticFiction for Title',     '', False, 'stip_ff.png',        'https://www.fantasticfiction.com/search/?searchfor=book&keywords={title}', 'utf-8', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'FictionDB for Author',           '', False, 'stip_fictiondb.png', 'https://www.fictiondb.com/search/searchresults.htm?styp=5&srchtxt={author}', 'utf-8', 'POST'),
        (False, 'FictionDB for Book',             '', False, 'stip_fictiondb.png', 'https://www.fictiondb.com/search/searchresults.htm?styp=5&author={author}&title={title}&srchtxt=multi&sgcode=0&tpcode=0&imprint=0&pubgroup=0&genretype=--&rating=-&myrating=-&status=-', 'utf-8', 'POST'),
        (False, 'FictionDB for ISBN',             '', False, 'stip_fictiondb.png', 'https://www.fictiondb.com/search/searchresults.htm?styp=5&srchtxt={isbn}', 'utf-8', 'POST'),
        (False, 'FictionDB for Title',            '', False, 'stip_fictiondb.png', 'https://www.fictiondb.com/search/searchresults.htm?styp=5&srchtxt={title}', 'utf-8', 'POST'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'Goodreads for Author',           '', False, 'stip_goodreads.png', 'https://www.goodreads.com/search/search?q={author}&search_type=books', 'utf-8', 'GET'),
        (False, 'Goodreads for Book',             '', False, 'stip_goodreads.png', 'https://www.goodreads.com/search/search?q={author}+{title}&search_type=books', 'utf-8', 'GET'),
        (False, 'Goodreads for ISBN',             '', False, 'stip_goodreads.png', 'https://www.goodreads.com/search/search?q={isbn}&search_type=books', 'utf-8', 'GET'),
        (False, 'Goodreads for Title',            '', False, 'stip_goodreads.png', 'https://www.goodreads.com/search/search?q={title}&search_type=books', 'utf-8', 'GET'),
        (True,  '', '', False, '', '', '', 'GET'),
        (True,  'Google images for Book',         '', False, 'stip_google.png',    'https://www.google.com/images?q=%22{author}%22+%22{title}%22', 'utf-8', 'GET'),
        (True,  'Google images 400x300',          '', False, 'stip_google.png',    'https://www.google.com/images?as_q={author}+%22{title}%22&tbs=isch:1,isz:lt,islt:qsvga,imgo:1&safe=off', 'utf-8', 'GET'),
        (True,  'Google.com for Book',            '', False, 'stip_google.png',    'https://www.google.com/#sclient=psy&q=%22{author}%22+%22{title}%22', 'utf-8', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'isfdb for Author',               '', False, 'stip_isfdb.png',     'https://www.isfdb.org/cgi-bin/se.cgi?type=Name&arg={author}', 'latin-1', 'GET'),
        (False, 'isfdb for Book',                 '', False, 'stip_isfdb.png',     'https://www.isfdb.org/cgi-bin/edit/tp_search.cgi?TERM_1={title}&USE_1=title&OPERATOR_1=AND&TERM_2={author}&USE_2=author&OPERATOR_2=AND' , 'latin-1', 'GET'),
        (False, 'isfdb for ISBN',                 '', False, 'stip_isfdb.png',     'https://www.isfdb.org/cgi-bin/se.cgi?type=ISBN&arg={isbn}', 'latin-1', 'GET'),
        (False, 'isfdb for Title',                '', False, 'stip_isfdb.png',     'https://www.isfdb.org/cgi-bin/se.cgi?type=Fiction+Titles&arg={title}', 'latin-1', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'Kobo for Author',                '', False, 'stip_kobo.png',      'https://www.kobobooks.com/search/search.html?q={author}&f=author','utf-8', 'GET'),
        (False, 'Kobo for Book',                  '', False, 'stip_kobo.png',      'https://www.kobobooks.com/search/search.html?q={author}+{title}&f=author','utf-8', 'GET'),
        (False, 'Kobo for Title',                 '', False, 'stip_kobo.png',      'https://www.kobobooks.com/search/search.html?q={title}','utf-8', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'Library of Congress for Author', '', False, 'stip_loc.png',       'https://catalog.loc.gov/cgi-bin/Pwebrecon.cgi?DB=local&Search_Arg={author}&Search_Code=NAME%40&CNT=100&hist=1&type=quick', 'utf-8', 'GET'),
        (False, 'Library of Congress for ISBN',   '', False, 'stip_loc.png',       'https://catalog.loc.gov/cgi-bin/Pwebrecon.cgi?DB=local&Search_Arg={isbn}&Search_Code=STNO^*&CNT=100&hist=1&type=quick', 'utf-8', 'GET'),
        (False, 'Library of Congress for Title',  '', False, 'stip_loc.png',       'https://catalog.loc.gov/cgi-bin/Pwebrecon.cgi?DB=local&Search_Arg={title}&Search_Code=TKEY^*&CNT=100&hist=1&type=quick', 'utf-8', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'LibraryThing for Author',        '', False, 'stip_lthing.png',    'https://www.librarything.com/search.php?search={author}', 'utf-8', 'GET'),
        (False, 'LibraryThing for Book',          '', False, 'stip_lthing.png',    'https://www.librarything.com/search.php?search={title}+{author}', 'utf-8', 'GET'),
        (False, 'LibraryThing for ISBN',          '', False, 'stip_lthing.png',    'https://www.librarything.com/search.php?search={isbn}', 'utf-8', 'GET'),
        (False, 'LibraryThing for Title',         '', False, 'stip_lthing.png',    'https://www.librarything.com/search.php?search={title}', 'utf-8', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'Literature-Map like Author',     '', False, 'stip_litmap.png',    'https://www.literature-map.com/{author}', 'utf-8', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'Lovereading for Author',         '', False, 'stip_loveread.png',  'https://www.lovereading.co.uk/search?s={author}', 'utf-8', 'GET'),
        (False, 'Lovereading for Book',           '', False, 'stip_loveread.png',  'https://www.lovereading.co.uk/search?s={author}+{title}&view=book-results', 'utf-8', 'GET'),
        (False, 'Lovereading for Title',          '', False, 'stip_loveread.png',  'https://www.lovereading.co.uk/search?s={title}&view=book-results', 'utf-8', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'ManyBooks for Author',           '', False, 'stip_manybooks.png', 'https://manybooks.net/search-book?search={author}', 'utf-8', 'GET'),
        (False, 'ManyBooks for Title',            '', False, 'stip_manybooks.png', 'https://manybooks.net/search-book?search={title}', 'utf-8', 'GET'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'NYTimes for Author',             '', False, 'stip_nyt.png',       'https://nytimes.com/search?query={author}',' utf-8'),
        (False, 'NYTimes for Book',               '', False, 'stip_nyt.png',       'https://nytimes.com/search?query={author}+{title}',' utf-8'),
        (False, 'NYTimes for Title',              '', False, 'stip_nyt.png',       'https://nytimes.com/search?query={title}',' utf-8'),
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'Waterstones for Author',         '', False, 'stip_wstones.png',   'https://www.waterstones.com/books/search/term/{author}', 'utf-8', 'GET'),
        (False, 'Waterstones for Book',           '', False, 'stip_wstones.png',   'https://www.waterstones.com/books/search/term/{title}+{author}', 'utf-8', 'GET'),
        (False, 'Waterstones for ISBN',           '', False, 'stip_wstones.png',   'https://www.waterstones.com/books/search/term/{isbn}', 'utf-8', 'GET'),
        ...
        (False, '', '', False, '', '', '', 'GET'),
        (False, 'Amazon.ca for Book',             '', False, 'stip_amazon.png',    'https://www.amazon.ca/s/ref=nb_sb_noss?url=search-alias%3Dstripbooks&field-keywords={author}+{title}', 'latin-1', 'GET'),
        (False, 'Amazon.cn for Book',             '', False, 'stip_amazon.png',    'https://www.amazon.cn/s/ref=nb_sb_noss?url=search-alias%3Dstripbooks&field-keywords={author}+{title}', 'latin-1', 'GET'),
        (False, 'Amazon.co.jp for Book',          '', False, 'stip_amazon.png',    'https://www.amazon.co.jp/s/ref=nb_sb_noss?url=search-alias%3Dstripbooks&field-keywords={author}+{title}', 'latin-1', 'GET'),
        (False, 'Amazon.de for Book',             '', False, 'stip_amazon.png',    'https://www.amazon.de/s/ref=nb_sb_noss?url=search-alias%3Dstripbooks&field-keywords={author}+{title}', 'latin-1', 'GET'),
        (False, 'Amazon.it for Book',             '', False, 'stip_amazon.png',    'https://www.amazon.it/s/ref=nb_sb_noss?url=search-alias%3Dstripbooks&field-keywords={author}+{title}', 'latin-1', 'GET'),
        (False, 'Amazon.fr for Book',             '', False, 'stip_amazon.png',    'https://www.amazon.fr/s/ref=nb_sb_noss?url=search-alias%3Dstripbooks&field-keywords={author}+{title}', 'latin-1', 'GET'),
        (False, 'Chapters.ca for Author',         '', False, 'stip_chapters.png',  'https://indigo.ca/en-ca/search/?q={author}', 'utf-8', 'GET'),
        (False, 'Chapters.ca for Book',           '', False, 'stip_chapters.png',  'https://indigo.ca/en-ca/search/?q={author}+{title}', 'utf-8', 'GET'),
        (False, 'Chapters.ca for ISBN',           '', False, 'stip_chapters.png',  'https://indigo.ca/en-ca/search/?q={isbn}', 'utf-8', 'GET'),
        (False, 'Chapters.ca for Title',          '', False, 'stip_chapters.png',  'https://indigo.ca/en-ca/search/?q={title}', 'utf-8', 'GET'),
        (False, 'Fnac for Author',                '', False, 'stip_fnac.png',      'https://recherche.fnac.com/Search/SearchResult.aspx?SCat=2&Search={author}', 'utf-8', 'GET'),
        (False, 'Fnac for Book',                  '', False, 'stip_fnac.png',      'https://recherche.fnac.com/Search/SearchResult.aspx?SCat=2&Search={author}+{title}', 'utf-8', 'GET'),
        (False, 'Fnac for Title',                 '', False, 'stip_fnac.png',      'https://recherche.fnac.com/Search/SearchResult.aspx?SCat=2&Search={title}', 'utf-8', 'GET'),
        (False, 'Google.de for Book',             '', False, 'stip_google.png',    'https://www.google.de/#sclient=psy&q=%22{author}%22+%22{title}%22', 'utf-8', 'GET'),
        (False, 'Google.es for Book',             '', False, 'stip_google.png',    'https://www.google.es/#sclient=psy&q=%22{author}%22+%22{title}%22', 'utf-8', 'GET'),
        (False, 'Google.fr for Book',             '', False, 'stip_google.png',    'https://www.google.fr/#sclient=psy&q=%22{author}%22+%22{title}%22', 'utf-8', 'GET'),
        (False, 'Google.it for Book',             '', False, 'stip_google.png',    'https://www.google.it/#sclient=psy&q=%22{author}%22+%22{title}%22', 'utf-8', 'GET'),
        (False, 'libri.de for Author',            '', False, 'stip_libri.png',     'https://www.libri.de/shop/action/advancedSearch?action=search&nodeId=-1&binderType=Alle&languageCode=DE&person={author}', 'utf-8', 'GET'),
        (False, 'libri.de for Book',              '', False, 'stip_libri.png',     'https://www.libri.de/shop/action/advancedSearch?action=search&nodeId=-1&binderType=Alle&languageCode=DE&title={title}&person={author}', 'utf-8', 'GET'),
        (False, 'libri.de for Title',             '', False, 'stip_libri.png',     'https://www.libri.de/shop/action/advancedSearch?action=search&nodeId=-1&binderType=Alle&languageCode=DE&title={title}', 'utf-8', 'GET'),
        (False, 'Wikipedia.de for Author',        '', False, 'stip_wikipedia.png', 'https://de.wikipedia.org/w/index.php?title=Special%3ASearch&search={author}', 'utf-8', 'GET'),
        (False, 'Wikipedia.de for Book',          '', False, 'stip_wikipedia.png', 'https://de.wikipedia.org/w/index.php?title=Special%3ASearch&search={author}+{title}', 'utf-8', 'GET'),
        (False, 'Wikipedia.de for Title',         '', False, 'stip_wikipedia.png', 'https://de.wikipedia.org/w/index.php?title=Special%3ASearch&search={title}', 'utf-8', 'GET'),
        (False, 'Wikipedia.es for Author',        '', False, 'stip_wikipedia.png', 'https://es.wikipedia.org/w/index.php?title=Special%3ASearch&search={author}', 'utf-8', 'GET'),
        (False, 'Wikipedia.es for Book',          '', False, 'stip_wikipedia.png', 'https://es.wikipedia.org/w/index.php?title=Special%3ASearch&search={author}+{title}', 'utf-8', 'GET'),
        (False, 'Wikipedia.es for Title',         '', False, 'stip_wikipedia.png', 'https://es.wikipedia.org/w/index.php?title=Special%3ASearch&search={title}', 'utf-8', 'GET'),
        (False, 'Wikipedia.fr for Author',        '', False, 'stip_wikipedia.png', 'https://fr.wikipedia.org/w/index.php?title=Sp%E9cial%3ARecherche&search={author}', 'utf-8', 'GET'),
        (False, 'Wikipedia.fr for Book',          '', False, 'stip_wikipedia.png', 'https://fr.wikipedia.org/w/index.php?title=Special%3ASearch&search={author}+{title}', 'utf-8', 'GET'),
        (False, 'Wikipedia.fr for Title',         '', False, 'stip_wikipedia.png', 'https://fr.wikipedia.org/w/index.php?title=Sp%E9cial%3ARecherche&search={title}', 'utf-8', 'GET'),
        (False, 'Wikipedia.it for Author',        '', False, 'stip_wikipedia.png', 'https://it.wikipedia.org/w/index.php?title=Special%3ASearch&search={author}', 'utf-8', 'GET'),
        (False, 'Wikipedia.it for Book',          '', False, 'stip_wikipedia.png', 'https://it.wikipedia.org/w/index.php?title=Special%3ASearch&search={author}+{title}', 'utf-8', 'GET'),
        (False, 'Wikipedia.it for Title',         '', False, 'stip_wikipedia.png', 'https://it.wikipedia.org/w/index.php?title=Special%3ASearch&search={title}', 'utf-8', 'GET')]
